...
metrics = [only_strategy_metric, sharpe_metric, sharpe_drawdown_metric, sharpe_drawdown_daily]#, wlr_rr_metric, mix_rrsimple_metric, complex_metric min_final_strategy_metric]
